...
<div class="max-w-3xl space-y-6">
    ...
    <div class="flex gap-3">
        ...
        @if($pembayaran->status == 'diverifikasi')
            <a href="{{ route('wali-siswa.pembayaran.kwitansi', $pembayaran) }}" target="_blank" class="inline-flex items-center gap-2 bg-navy text-white font-medium px-4 py-2 rounded-xl hover:bg-navy/90 transition">
